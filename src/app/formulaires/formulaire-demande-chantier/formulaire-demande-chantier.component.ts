...
export class FormulaireDemandeChantierComponent implements OnInit {
    ...
    change(jour: JourSemaineType): void {
        ...
        if (this.joursRegularite.includes(jour)) {
            ...
            delete this.joursRegularite[jour];
    ...
    onSubmit(): void {
        const site =
            this.demandeDeChantierForm.controls.site.value === ""
                ? null
                : this.demandeDeChantierForm.controls.site.value;
        const client =
            this.demandeDeChantierForm.controls.client.value === ""
                ? null
                : this.demandeDeChantierForm.controls.client.value;

        const adresse =
            this.demandeDeChantierForm.controls.adresse.value +
            "," +
        ...
        const estimationTemps =
            this.demandeDeChantierForm.controls.estimationTemps.value === ""
                ? null
                : this.demandeDeChantierForm.controls.estimationTemps.value;
        const particularite =
            this.demandeDeChantierForm.controls.particularite.value === ""
                ? null
                : this.demandeDeChantierForm.controls.particularite.value;
        const description =
            this.demandeDeChantierForm.controls.description.value === ""
                ? null
                : this.demandeDeChantierForm.controls.description.value;
        const informationsInterne =
            this.demandeDeChantierForm.controls.informationsInterne.value === ""
                ? null
                : this.demandeDeChantierForm.controls.informationsInterne.value;
