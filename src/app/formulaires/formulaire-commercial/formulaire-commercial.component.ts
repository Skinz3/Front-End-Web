...
export class FormulaireCommercialComponent implements OnInit {
  ...
  @ViewChild(FormulaireEstimationComponent /* #name or Type*/, {
    static: false,
  })
  child;
  ...
  ngOnInit(): void {
    this.formCommercial = new FormGroup({
      dateDebutTheorique: new FormControl(
        this.chantier.dateDebutTheorique != null
          ? this.chantier.dateDebutTheorique
          : ""
      ),
      dateFinTheorique: new FormControl(
        this.chantier.dateFinTheorique != null
          ? this.chantier.dateFinTheorique
          : ""
      ),
    });
  }
  ...
  onSubmit(): void {
    const dateDebutTheorique: Date =
      this.formCommercial.controls.dateDebutTheorique.value === ""
        ? null
        : this.formCommercial.controls.dateDebutTheorique.value;
    const dateFinTheorique: Date =
      this.formCommercial.controls.dateFinTheorique.value === ""
        ? null
        : this.formCommercial.controls.dateFinTheorique.value;
    ...
    this.chantierService
      .updateChantierById(this.chantier.id + "", chantierToUpdate)
      .subscribe();
    this.child.onSubmit();
  }
}
