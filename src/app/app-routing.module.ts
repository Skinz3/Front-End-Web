...
import { PageAccueilComponent } from "./affichage/page-accueil/page-accueil.component";

const routes: Routes = [
  {
    path: "demande-de-cantier",
    component: FormulaireDemandeChantierComponent,
  ...
  {
    path: "nouvelle-demande-de-chantier",
    component: FormulaireDemandeChantierComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "nouveau-site",
    component: FormulaireSiteComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "client",
  ...
  {
    path: "detail-chantier/:id",
    component: DetailChantierComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "detail-demande-de-chantier/:id",
    component: DetailDemandeDeChantierComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "liste-chantier",
    component: ListChantiersComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "liste-client",
  ...
  {
    path: "liste-demande-de-chantier",
    component: ListDemandeDeChantierComponent,
    canActivate: [AuthGuard],
  },
  ...
  // {path: '', component: HomeComponent, canActivate: [AuthGuard]},
  {
    ...
    component: StepperFicheInterventionComponent,
    canActivate: [AuthGuard],
  },
];
